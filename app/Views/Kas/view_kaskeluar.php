                                        ...
                                        <tbody>
                                            ...
                                            foreach ($kaskeluar as $val) {
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-success btn-sm btn-edit" data-tanggal="<?= $val['tanggal']; ?>" data-ket="<?= $val['ket']; ?>" data-kas_keluar="<?= $val['kas_keluar']; ?>" data-jenis_kas="<?= $val['jenis_kas'];  ?>">
...
<form action="/kaskeluar/save" method="post">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Uang Keluar</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"></span></button>
                </div>
                <div class="modal-body">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <label><b>kas_keluar</b></label>
                        <input type="text" class="form-control" name="kas_keluar">
                    </div>
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label><b>jenis kas</b></label>
