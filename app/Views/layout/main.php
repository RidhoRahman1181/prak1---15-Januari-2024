        ...
        <div class="left side-menu">
            ...
            <div class="topbar-left">
                <div class="text-center">
                    ...
                    <img src="<?= base_url() ?>/gambar/Logo Masjid.PNG" width="75">
                </div>
            </div>
            <span>Assalamu'alaikum Warahmatullah Wabarakatuh,
                <?= $u = (session()->get('nama_user'));
                ?>
                <br><br>

                <img src=" <?php echo base_url() . '/gambar/' . $u . '.PNG' ?>" height="160" width="160">
            </span>
                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                    ...
                                    <a class="dropdown-item" href="<?= site_url('Login') ?>"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
                                </div>
                            </li>
